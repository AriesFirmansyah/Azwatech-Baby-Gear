    ...
    <div class="sidebar" data-color="purple" data-background-color="white" data-image="Template Material/assets/img/sidebar-1.jpg">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item {{request()->is('adminProducts') ? 'active' : '' }}{{request()->is('adminAddProduct') ? 'active' : '' }}">
            <a class="nav-link" href="adminProducts">
              <i class="material-icons">inventory_2</i>
              <p>Products</p>
            </a>
          </li>
          <li class="nav-item {{request()->is('adminOrders') ? 'active' : '' }}">
          ...
          <li class="nav-item {{request()->is('adminCarts') ? 'active' : '' }}">
            <a class="nav-link" href="adminCarts">
